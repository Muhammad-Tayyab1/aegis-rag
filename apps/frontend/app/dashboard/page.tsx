...
type Tenant = {name: string; slug: string; plan: string; chunkSize: number; retrievalStrategy: string; rerankEnabled: boolean}
export default function DashboardPage() {
	...
	useEffect(() => {
		...
		fetch(`${process.env.NEXT_PUBLIC_API_URL ?? 'http://localhost:4000/api'}/tenants/me`, {headers: {Authorization: `Bearer ${token}`}})
			.then(async (r) => {
		...
		<main className="dashboard">
			...
			<section>
				...
				<div className="empty">
					...
					<p>Connect a source or upload a document to begin building your retrieval index.</p>
